...
public abstract class ShaderHandler {
    ...
    public ShaderHandler(String vertexFile, String fragmentFile){
    ...
    protected int getAllUniformLocation(String name){
    ...
    protected void bindAttribute(int attibrute, String variableName){
        GL20.glBindAttribLocation(programID, attibrute, variableName);
    }
