...
public class Maths {
    public static Matrix4f createTransformationMatrix(Vector3f tranlation, float rx, float ry, float rz, float scale){
        Matrix4f matrix4f = new Matrix4f();
        matrix4f.setIdentity();
        Matrix4f.translate(tranlation, matrix4f, matrix4f);
